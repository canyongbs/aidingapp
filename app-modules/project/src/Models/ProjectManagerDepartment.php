...
/**
 * @mixin IdeHelperProjectManagerDepartment
 */
class ProjectManagerDepartment extends Pivot
{
    use HasUuids;

    public function getTable(): string
    {
        return TeamRenameFeature::active() ? 'project_manager_departments' : 'project_manager_teams';
    }
