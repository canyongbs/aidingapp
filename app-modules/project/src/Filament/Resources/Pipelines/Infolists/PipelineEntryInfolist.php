...
namespace AidingApp\Project\Filament\Resources\Pipelines\Infolists;
...
class PipelineEntryInfolist
{
    /**
     * Returns the shared read-only infolist components used to view a pipeline entry.
     *
