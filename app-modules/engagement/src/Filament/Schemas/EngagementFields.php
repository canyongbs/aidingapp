...
namespace AidingApp\Engagement\Filament\Schemas;
...
class EngagementFields
{
    public static function getDeliveryMethodField(): Select
    {
        return Select::make('channel')
     ...
     */
    public static function getContentSchema(mixed $draftWithAiAction): array
    {
        return [
     ...
     * @return array<Component>
     */
    public static function getScheduleSchema(string $helperText = 'By default, this email or text will send as soon as it is created unless you schedule it to send later.'): array
    {
        return [
