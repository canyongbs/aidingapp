...
class EngagementResponsePolicy
{
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ['engagement_response.*.view', "engagement_response.{$engagementResponse->getKey()}.view"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ['engagement_response.*.update', "engagement_response.{$engagementResponse->getKey()}.update"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ['engagement_response.*.delete', "engagement_response.{$engagementResponse->getKey()}.delete"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ['engagement_response.*.restore', "engagement_response.{$engagementResponse->getKey()}.restore"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ['engagement_response.*.force-delete', "engagement_response.{$engagementResponse->getKey()}.force-delete"],
