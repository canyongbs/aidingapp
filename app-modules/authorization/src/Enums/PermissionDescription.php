...
enum PermissionDescription: string
{
    ...
    case Advisory = 'This permission group enables the display and management of the Advisory feature in the primary navigtion group Service Management. Permission options include create, view, update, and delete advisories.';
    ...
    case ReportLibrary = 'This permission group enables the display of the Report Library feature in the primary navigation group Analytics. Permission options include view report libraries.';
