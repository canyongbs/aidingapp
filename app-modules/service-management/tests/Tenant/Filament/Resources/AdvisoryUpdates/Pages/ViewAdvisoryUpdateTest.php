...
test('The correct details are displayed on the ViewAdvisoryUpdate page', function () {
    $advisoryUpdate = AdvisoryUpdate::factory()->create();
...
test('ViewAdvisoryUpdate is gated with proper access control', function () {
...
test('ViewAdvisoryUpdate is gated with proper feature access control', function () {
