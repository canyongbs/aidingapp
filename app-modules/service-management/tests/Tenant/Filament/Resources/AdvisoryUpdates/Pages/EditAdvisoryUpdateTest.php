...
use AidingApp\ServiceManagement\Tests\Tenant\RequestFactories\EditAdvisoryUpdateRequestFactory;
use App\Models\User;
...
test('A successful action on the EditAdvisoryUpdate page', function () {
    ...
    $request = collect(EditAdvisoryUpdateRequestFactory::new()->create());
...
test('EditAdvisoryUpdate is gated with proper access control', function () {
...
test('EditAdvisoryUpdate is gated with proper feature access control', function () {
    ...
    assertEquals($request['update'], $advisoryUpdate->fresh()->update);
});
