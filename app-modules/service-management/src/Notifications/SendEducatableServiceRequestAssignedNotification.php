...
class SendEducatableServiceRequestAssignedNotification extends Notification implements ShouldQueue, HasBeforeSendHook, HasAfterSendHook, HasOutboundMailCustomization
{
    use Queueable;
