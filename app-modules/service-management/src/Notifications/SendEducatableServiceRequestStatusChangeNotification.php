...
class SendEducatableServiceRequestStatusChangeNotification extends Notification implements ShouldQueue, HasBeforeSendHook, HasAfterSendHook, HasOutboundMailCustomization
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $message = MailMessage::make()
            ...
            ->subject(filled($subject) ? strip_tags($subject) : "Status update: Service request {$this->serviceRequest->service_request_number} is now {$this->serviceRequest->status?->name}");
