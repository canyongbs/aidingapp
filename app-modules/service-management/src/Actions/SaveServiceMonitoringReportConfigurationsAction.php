...
{
    /**
     * @param array<string, array{is_active?: bool, report_users?: array<int, string>, report_departments?: array<int, string>, report_contacts?: array<int, string>, report_channels?: array<int, string>}> $reportConfigurationsData
     */
