...
class SubmitServiceRequestDraft
{
    ...
    protected function assignStatus(ServiceRequest $draft, SystemServiceRequestClassification $classification): void
    {
        $status = $this->findStatus($classification);
    ...
    protected function assignRequestNumber(ServiceRequest $draft): void
    {
    ...
    protected function markAsSubmitted(ServiceRequest $draft): void
    {
