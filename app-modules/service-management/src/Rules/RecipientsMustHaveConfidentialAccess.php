...
/**
 * Shared "which of these recipients can't see this confidential monitor" predicate, used by both
 * the notification-recipients and report-recipients confidentiality rules. Subclasses only supply
 * the failure message wording for their own recipient list.
 */
abstract class RecipientsMustHaveConfidentialAccess implements ValidationRule
{
    /**
    ...
    public function __construct(
        ...
        protected array $recipientDepartmentIds,
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        $fail($this->failureMessage($unreachable));
    }
    ...
    protected function unreachableDepartmentNames(): Collection
    {
        return Department::query()
            ->whereKey($this->recipientDepartmentIds)
            ->when(
    ...
    {
        return User::query()
            ->whereKey($this->recipientUserIds)
