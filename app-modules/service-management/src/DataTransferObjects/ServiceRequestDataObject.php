...
class ServiceRequestDataObject extends Data
{
    public function __construct(
        ...
        public string $respondent_type, //remove during MakeContactNotPolymorphicFeature cleanup
    ...
    public static function fromData(array $data): static
    {
        return new self(
            ...
            respondent_type: $data['respondent_type'], //remove during MakeContactNotPolymorphicFeature cleanup
        );
    }
}
