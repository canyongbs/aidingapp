...
class AdvisorySeverityPolicy
{
    ...
    public function view(Authenticatable $authenticatable, AdvisorySeverity $advisorySeverity): Response
    {
        return $authenticatable->canOrElse(
    ...
    public function update(Authenticatable $authenticatable, AdvisorySeverity $advisorySeverity): Response
    {
        return $authenticatable->canOrElse(
    ...
    public function delete(Authenticatable $authenticatable, AdvisorySeverity $advisorySeverity): Response
    {
        if ($advisorySeverity->advisories()->exists()) {
            return Response::deny('The advisory severity cannot be deleted because it is associated with an advisory.');
        }
    ...
    public function forceDelete(Authenticatable $authenticatable, AdvisorySeverity $advisorySeverity): Response
    {
        if ($advisorySeverity->advisories()->exists()) {
            return Response::deny('The advisory severity cannot be deleted because it is associated with an advisory.');
        }
