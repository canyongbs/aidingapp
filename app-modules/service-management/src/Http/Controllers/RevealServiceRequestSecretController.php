...
class RevealServiceRequestSecretController
{
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $secret = Secret::query()->findOrFail($data['secret_id']);
        $serviceRequest = $secret->related;

        abort_unless($serviceRequest instanceof ServiceRequest, Response::HTTP_NOT_FOUND);
