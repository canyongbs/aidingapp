...
/**
 * @mixin IdeHelperServiceMonitoringTargetDepartment
 */
class ServiceMonitoringTargetDepartment extends Pivot
{
    use HasUuids;

    /** @use HasFactory<ServiceMonitoringTargetDepartmentFactory> */
    use HasFactory;
