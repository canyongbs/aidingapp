...
/**
 * @mixin IdeHelperServiceRequestTypeDepartmentAuditor
 */
class ServiceRequestTypeDepartmentAuditor extends Pivot
{
    /** @use HasFactory<ServiceRequestTypeDepartmentAuditorFactory> */
    use HasFactory;
