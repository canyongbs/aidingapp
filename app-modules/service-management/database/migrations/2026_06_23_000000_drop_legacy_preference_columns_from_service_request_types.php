...
return new class () extends Migration {
    ...
    {
        Schema::table('service_request_types', function (Blueprint $table): void {
            $table->dropColumn([
    ...
    public function down(): void
    {
        Schema::table('service_request_types', function (Blueprint $table): void {
            ...
            $table->boolean('is_managers_service_request_closed_email_enabled')->default(false);
            ...
            $table->boolean('is_managers_service_request_closed_notification_enabled')->default(false);
            ...
            $table->boolean('is_auditors_service_request_update_email_enabled')->default(false);
            $table->boolean('is_auditors_service_request_status_change_email_enabled')->default(false);
            $table->boolean('is_auditors_service_request_closed_email_enabled')->default(false);
            ...
            $table->boolean('is_auditors_service_request_update_notification_enabled')->default(false);
            $table->boolean('is_auditors_service_request_status_change_notification_enabled')->default(false);
            $table->boolean('is_auditors_service_request_closed_notification_enabled')->default(false);
