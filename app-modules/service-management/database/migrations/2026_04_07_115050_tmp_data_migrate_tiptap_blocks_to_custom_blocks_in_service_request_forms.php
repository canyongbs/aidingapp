...
return new class () extends Migration {
    ...
    {
        $this->processTable('service_request_forms', 'content');
        $this->processTable('service_request_form_steps', 'content');
    }

    public function down(): void
    {
        // This migration transforms tiptapBlock nodes to customBlock nodes,
        // and grid attributes to the new Filament v4 format.
        // A reverse migration is not provided because the old TiptapEditor
        // format is being fully replaced by Filament v4's RichEditor.
    }
