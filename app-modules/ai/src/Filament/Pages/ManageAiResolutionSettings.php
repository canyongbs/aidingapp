...
{
    protected static string $settings = AiResolutionSettings::class;
                ...
                Section::make('AI Resolution Settings')
                    ...
                    ->schema([
                        Toggle::make('is_enabled')
                            ->label('Enable AI Resolution')
                            ->helperText('When enabled, users submitting service requests will be offered an AI-generated solution if the AI is confident it can resolve the issue.'),
