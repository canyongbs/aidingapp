...
use AidingApp\ServiceManagement\Actions\QueueServiceRequestConversation;
...
class RequestServiceRequestConversationController extends Controller
{
    public function __invoke(Request $request, ServiceRequest $serviceRequest): JsonResponse
    {
        ...
        try {
            $conversation = app(QueueServiceRequestConversation::class)->execute($serviceRequest, $contact);
