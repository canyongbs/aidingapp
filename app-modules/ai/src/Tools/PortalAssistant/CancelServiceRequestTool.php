...
class CancelServiceRequestTool extends Tool
{
    ...
    public function __construct(
        ...
        $this
            ->as('cancel_service_request')
            ->for('Cancels the current service request draft, allowing the user to start over or select a different request type. Use when the user wants to abandon their current request, change to a different type, or start fresh. The draft is preserved and can be restored if the user selects the same type again.')
            ->using($this);
    }
