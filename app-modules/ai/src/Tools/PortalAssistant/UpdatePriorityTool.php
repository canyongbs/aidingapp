...
class UpdatePriorityTool extends Tool
{
    ...
    public function __construct(
        ...
        $this
            ->as('update_priority')
            ->for('Updates the priority of the service request draft.')
            ->withStringParameter('priority_id', 'The UUID of the priority to set')
            ->using($this);
    }
    ...
    public function __invoke(string $priority_id): string
    {
        ...
        if (! $priority) {
            return json_encode([
                'success' => false,
                'error' => 'Priority not found for this service request type.',
            ]);
        }
