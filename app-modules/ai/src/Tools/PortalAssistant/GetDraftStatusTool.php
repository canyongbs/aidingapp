...
class GetDraftStatusTool extends Tool
{
    ...
    public function __construct(
        ...
        $this
            ->as('get_draft_status')
            ->for('Returns the current draft state with form fields, missing requirements, and next_instruction. Call at conversation start if resuming a draft, or as a fallback if you lose track of state. Action tools already include this info in their responses.')
            ->using($this);
    }
