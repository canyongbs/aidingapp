...
trait SubmitsServiceRequest
{
    ...
    {
        $this->recordAiResolutionOutcome($draft, $resolutionAccepted, $resolutionUpdateUuid);

        $statusClassification = $resolutionAccepted
    ...
    protected function recordAiResolutionOutcome(ServiceRequest $draft, bool $wasAccepted, ?string $resolutionUpdateUuid = null): void
    {
        ...
        $proposedAnswer = $this->extractProposedAnswer($aiResolutionUpdate->update);
    ...
    protected function extractProposedAnswer(string $updateText): string
    {
