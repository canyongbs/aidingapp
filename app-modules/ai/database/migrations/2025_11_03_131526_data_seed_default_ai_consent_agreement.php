...
return new class () extends Migration {
        ...
        DB::table('consent_agreements')
            ->insert([
                ...
                'body' => <<<EOT
                    ...
                    Welcome to Canyon GBS's AI Assistant Tool. This Acceptable Use Policy ("Policy”) governs the use of generative AI assistant tools (“AI Assistant Tool”), including but not limited to the Aiding App by Canyon GBS™, by all employees (“You” or “Your”). By using the AI Assistant Tool, You agree to comply with this Policy. Failure to comply may result in disciplinary action, up to and including termination of access and legal consequences.

                    Acceptable Uses

                    1.1. Authorized Users. The AI Assistant Tool is provided for use by Canyon GBS for legitimate work-related purposes only. The AI Assistant Tool is to be utilized exclusively for professional activities that directly support Your duties at Canyon GBS. The use of these technologies for personal gain or activities outside the scope of Your responsibilities during work hours is strictly prohibited.

                    1.2. Professional Conduct. You are expected to use the AI Assistant Tool in a professional manner and in accordance with Canyon GBS’ policies and procedures.
                    ...
                    1.4. Compliance with Law. You shall comply with all applicable laws, regulations, and Canyon GBS policies when using the AI Assistant Tool.
                    ...
                    2.10. Unauthorized Users: The AI Assistant Tool provided by Canyon GBS is only for use by authorized staff members. Sharing or allowing others to use it without written consent from [AI Tool Administrator Name/Department] is strictly prohibited. Unauthorized use may result in disciplinary action.

                    Monitoring and Enforcement. Canyon GBS may monitor the use of the AI Assistant Tool to ensure compliance with this Policy and applicable laws. Violations of this Policy may result in disciplinary action, including but not limited to temporary or permanent suspension of access to the AI Assistant Tool, and legal action as deemed appropriate.
                    ...
                    Modification of Policy: Canyon GBS reserves the right to modify or update this Policy at any time. You will be notified of any changes, and continued use of the AI Assistant Tool after such modifications constitute acceptance of the revised Policy.
    ...
    {
        DB::table('consent_agreements')->truncate();
    }
};
