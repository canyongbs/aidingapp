...
it('removes password fields from stale form data', function () {
    ...
    $passwordField->delete();
    $form->archive();

    $secretId = '00000000-0000-0000-0000-000000000001';
    $formData = ['Details' => [
        $passwordField->getKey() => $secretId,
        'ordinary-field' => 'Visible answer',
    ]];

    expect(app(RemovePasswordsFromServiceRequestFormData::class)($type, $formData))
        ->toBe(['Details' => ['ordinary-field' => 'Visible answer']]);
});
