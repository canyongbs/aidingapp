...
class InteractionCampaignPolicy
{
    ...
    public function view(Authenticatable $authenticatable, InteractionCampaign $campaign): Response
    {
        return $authenticatable->canOrElse(
    ...
    public function update(Authenticatable $authenticatable, InteractionCampaign $campaign): Response
    {
        return $authenticatable->canOrElse(
    ...
    public function delete(Authenticatable $authenticatable, InteractionCampaign $campaign): Response
    {
        return $authenticatable->canOrElse(
    ...
    public function restore(Authenticatable $authenticatable, InteractionCampaign $campaign): Response
    {
        return $authenticatable->canOrElse(
    ...
    public function forceDelete(Authenticatable $authenticatable, InteractionCampaign $campaign): Response
    {
        return $authenticatable->canOrElse(
