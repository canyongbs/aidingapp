...
use AidingApp\Contact\Tests\Tenant\ContactStatus\RequestFactories\CreateContactStatusRequestFactory;
use App\Models\User;
...
test('CreateContactStatus requires valid data', function (CreateContactStatusRequestFactory $data, array $errors) {
    asSuperAdmin();
    ...
    [
        'name missing' => [fn () => CreateContactStatusRequestFactory::new()->without('name'), ['name' => 'required']],
        'name not a string' => [fn () => CreateContactStatusRequestFactory::new()->state(['name' => 1]), ['name' => 'string']],
        'color missing' => [fn () => CreateContactStatusRequestFactory::new()->state(['color' => null]), ['color' => 'required']],
        'color not within enum' => [fn () => CreateContactStatusRequestFactory::new()->state(['color' => 'not-a-color']), ['color' => Enum::class]],
    ]
);
