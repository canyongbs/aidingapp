...
class CreateOrganizationRequestFactory extends RequestFactory
{
    public function definition(): array
    {
        return [
            ...
            'industry_id' => OrganizationIndustry::inRandomOrder()->first() ?? OrganizationIndustry::factory()->create()->id,
            'type_id' => OrganizationType::inRandomOrder()->first() ?? OrganizationType::factory()->create()->id,
