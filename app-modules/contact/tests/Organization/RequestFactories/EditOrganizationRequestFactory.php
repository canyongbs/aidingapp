...
class EditOrganizationRequestFactory extends RequestFactory
{
    public function definition(): array
    {
        return [
            ...
            'industry_id' => OrganizationIndustry::inRandomOrder()->first()->id ?? OrganizationIndustry::factory()->create()->id,
            'type_id' => OrganizationType::inRandomOrder()->first()->id ?? OrganizationType::factory()->create()->id,
