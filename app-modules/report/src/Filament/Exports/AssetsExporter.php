...
class AssetsExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('status.name')
                ->label('Status'),
            ExportColumn::make('deployment_status')
                ->label('Deployment')
    ...
    {
        $body = 'Your assets export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
