...
<x-filament-panels::page full-height="true">
                ...
                <div class="col-span-1 flex h-full flex-col gap-2 overflow-hidden md:col-span-3"
                    ...
                    <template x-if="!loading && error">
                        <div class="flex flex-col items-center self-center">
                            ...
                            <x-filament::button class="mt-2" x-on:click="errorRetry">Retry
                            </x-filament::button>
                        </div>
                    </template>
                    <div class="col-span-1 flex h-full flex-col gap-2 overflow-hidden md:col-span-3"
                        x-show="!loading && !error" x-transition.delay.850ms>
                        <div
                                        ...
                                        <div class="m-auto justify-center px-6 py-3 text-base">
                                            <div
                                                ...
                                                <div class="relative mt-1 flex flex-shrink-0 flex-col items-end">
                                                    <x-filament::avatar class="rounded-full" alt="User Avatar"
                                                        x-bind:src="message.avatar" size="lg" />
                                                </div>
                                                <div
                                                    ...
                                                    <div class="flex max-w-full flex-grow flex-col gap-y-1">
                                                        <div class="flex items-center gap-2 text-sm">
                                                            <span class="font-medium text-gray-700 dark:text-gray-300"
                                                                x-text="message.author"></span>
                                                            <span class="text-gray-500 dark:text-gray-500"
                                                                x-text="formatDate(message.date)"></span>
                                                        </div>

                                                        <div
                                                            class="flex min-h-[20px] flex-col items-start gap-3 overflow-x-auto break-words">
                                                            <div x-html="generateHTML(JSON.parse(message.message.body))">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <template x-if="messagePaginator?.hasPrevPage">
                                <div class="mb-auto flex cursor-pointer justify-center bg-white p-3 text-center text-primary-500 dark:bg-gray-700"
                                    x-on:click="loadPreviousMessages">
                                    <p>Load previous messages...</p>
                                    <x-filament::loading-indicator class="ml-2 h-4 w-4 text-primary-500"
                            ...
                            <div
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <form
                                                        ...
                                                        x-on:submit.prevent="saveLink" x-cloak
                                                        x-float.offset.placement.bottom-start="{ offset: 8 }"
                                                        x-ref="linkEditor" x-on:click.outside="$el.close"
                                                        ...
                                                        <label class="grid gap-y-2">
                                                            ...
                                                            <x-filament::input.wrapper>
                                                                <x-filament::input type="url" x-model="linkUrl"
                                                                    x-ref="linkInput" />
                                                            </x-filament::input.wrapper>
                                                        </label>
                                                        ...
                                                        <div class="flex flex-wrap items-center gap-3">
                                                            ...
                                                            <x-filament::button type="button" size="sm" x-show="linkUrl"
                                                                x-on:click="removeLink" color="gray">
                                                                Remove
                                                            </x-filament::button>
                                                        </div>
                                                    </form>
                                                ...
                                                <div>
                                                    <button class="rounded p-0.5" type="button"
                                                        x-on:click="$refs.colorPicker.toggle" x-bind:class="{
                                                    ...
                                                    <div class="absolute z-10 max-w-xs divide-y divide-gray-100 rounded-lg bg-white px-4 py-3 shadow-lg ring-1 ring-gray-950/5 transition dark:divide-white/5 dark:bg-gray-900 dark:ring-white/10"
                                                        x-cloak x-float.offset.placement.top-start="{ offset: 8 }"
                                                        x-ref="colorPicker" x-transition:enter-start="opacity-0"
                                                        x-transition:leave-end="opacity-0">
                                                        <div class="flex flex-wrap items-center gap-2">
                                                            <button
                                                                class="flex h-5 w-5 items-center rounded-full border bg-gray-50 dark:border-gray-400 dark:bg-gray-800"
                                                                type="button" x-on:click="removeColor()"
                                                                x-bind:class="{
                                                                ...
                                                                <div class="flex-1 rotate-45 border-t dark:border-gray-400">
                                                                </div>
                                                            </button>

                                                            <button class="h-5 w-5 rounded-full bg-[#ef4444]" type="button"
                                                            ...
                                                            <button class="h-5 w-5 rounded-full bg-[#ec4899]" type="button"
                                                            ...
                                                            <button class="h-5 w-5 rounded-full bg-[#3b82f6]" type="button"
                                                            ...
                                                            <button class="h-5 w-5 rounded-full bg-[#22c55e]" type="button"
                                                            ...
                                                            <button class="h-5 w-5 rounded-full bg-[#eab308]" type="button"
                                                            ...
                                                            <button class="h-5 w-5 rounded-full bg-[#737373]" type="button"
                                                ...
                                                <div>
                                                    ...
                                                    <div class="absolute z-10 max-w-xs divide-y divide-gray-100 rounded-lg bg-white px-4 py-3 shadow-lg ring-1 ring-gray-950/5 transition dark:divide-white/5 dark:bg-gray-900 dark:ring-white/10"
                                                        x-cloak x-float.offset.placement.top-start="{ offset: 8 }"
                                                        x-ref="emojiPicker" x-transition:enter-start="opacity-0"
                                                        x-transition:leave-end="opacity-0">
                                                        <div class="flex flex-wrap items-center gap-2">
                                                            <template
                                                                x-for="emoji in ['😀', '😂', '👍', '👎', '🙏', '😕', '🤔', '😊', '🎉', '💼', '🕒', '📅', '🔒', '❗', '❓', '💡', '🚫', '✅', '🤖', '📧', '🌐', '💬', '📈', '📉', '🤝']">
                                                                <button
                                                                    ...
                                                                    type="button" x-on:click="insertContent(emoji)"
                                                                    x-text="emoji" x-bind:key="emoji"></button>
                                                            </template>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="flex items-center justify-between border-t px-3 py-2 dark:border-gray-600">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="relative flex h-6 items-center justify-center gap-0.5"
                                            x-show="usersTyping.length">
                                            <template x-for="user in usersTyping">
                                                <x-filament::avatar alt="User Avatar" size="w-4 h-4"
                                                    x-bind:src="user.avatar" />
                                            </template>
                                            <span
                                                class="h-2 w-2 animate-bounce rounded-full bg-primary-500 text-primary-500 animation-delay-100"></span>
                                            <span
                                                class="h-2 w-2 animate-bounce rounded-full bg-primary-500 text-primary-500 animation-delay-200"></span>
                                            <span
                                                class="h-2 w-2 animate-bounce rounded-full bg-primary-500 text-primary-500 animation-delay-300"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <x-filament::modal id="confirmSafeLink" width="2xl">
        ...
        <x-slot name="description">
            <div class="mt-4 flex flex-col" x-data="{ href: null }" x-on:open-modal.window="href = $event.detail.href">
        ...
        <x-slot name="footerActions">
            <div class="flex w-full justify-between" x-data="{ href: null }"
