...
class UpdateParticipantRole
{
    public function __invoke(
        ...
        if ($conversation->type === ConversationType::Direct) {
            throw new InvalidArgumentException('Cannot update participant roles in direct message conversations.');
        }
        ...
        if (! $isManager && $participant->is_manager) {
            $hasOtherManagers = ConversationParticipant::query()
                ->whereBelongsTo($conversation)
