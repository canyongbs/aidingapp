...
class UpdateParticipantSettings
{
    public function __invoke(
        Conversation $conversation,
        User $user,
        ?bool $isPinned = null,
        ?ConversationNotificationPreference $notificationPreference = null,
        ...
        if ($notificationPreference !== null) {
            $participant->notification_preference = $notificationPreference;
            $changed = true;
        }
