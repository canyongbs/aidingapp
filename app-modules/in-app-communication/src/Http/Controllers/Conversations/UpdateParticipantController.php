...
{
    public function __invoke(Request $request, Conversation $conversation, User $user): JsonResponse
    {
        $this->authorize('updateParticipant', $conversation);
        ...
        $participant = app(UpdateParticipantRole::class)(
            ...
            user: $user,
            isManager: $validated['is_manager'],
        );
