...
class UpdateSettingsController extends Controller
{
    public function __invoke(Request $request, Conversation $conversation): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'notification_preference' => ['sometimes', 'string', 'in:all,mentions,none'],
        ]);
        ...
        $participant = app(UpdateParticipantSettings::class)(
            ...
            notificationPreference: isset($validated['notification_preference'])
                ? ConversationNotificationPreference::from($validated['notification_preference'])
                : null,
        );
        ...
        return response()->json([
            'data' => [
                ...
                'notification_preference' => $participant->notification_preference->value,
            ],
        ]);
    }
}
