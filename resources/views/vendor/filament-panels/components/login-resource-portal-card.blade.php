...
<div class="bg-turkish-300 text-white rounded-xl p-6">
    <div class="flex md:flex-row flex-col justify-center items-center gap-6">
        <div>
            ...
            <a href="https://canyongbs.aiding.app/portal/categories/advising-app"  target="_blank" class="border-2 border-gray-700 px-4 py-2 text-gray-700 rounded-xl text-sm font-semibold inline-block">Visit Resource Portal</a>
        </div>
