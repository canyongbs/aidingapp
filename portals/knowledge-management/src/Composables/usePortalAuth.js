...
/**
 * Handles the passwordless (email code) authentication flow, self-registration and
 * logout for the portal. On successful authentication the token is persisted and the
 * portal is reloaded, which re-boots it in the authenticated state so the route data
 * loaders refetch with the token and the user-scoped configuration is re-resolved.
 */
