...
function getData() {
    ...
    fetch(props.apiUrl + '/new-request')
            ...
            >
                ...
                <div class="flex h-full w-full flex-col rounded bg-primary-700 px-12 py-4">
                    <div class="flex flex-col text-left">
                        ...
                        <p class="text-white">We understand that you need some help, we're on it! Please complete the form below.</p>
                    </div>
                </div>
            </div>
                    ...
                    >
                        <div class="flex items-center gap-x-3">
                            ...
                            <div class="w-full">
                                ...
                                <router-link :to="{ name: 'new-request-type', params: { typeId: type.id } }">
