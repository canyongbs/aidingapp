    ...
    <div class="flex w-full flex-col py-4">
        ...
        <div class="flex w-full justify-center pb-4 pt-2">
            <span class="w-11/12 text-center text-xs lg:w-3/4 xl:w-7/12">
                &copy; 2016-{{ new Date().getFullYear() }} Canyon GBS Inc. All Rights Reserved. Canyon GBS&reg; and Aiding
                App&reg; are trademarks of Canyon GBS Inc. For more information or inquiries, please visit our website at
