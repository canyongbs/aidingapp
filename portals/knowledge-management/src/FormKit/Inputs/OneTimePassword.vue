...
<template>
    <input
        ...
        maxlength="1"
        class="ring-1 ring-gray-400 focus-within:ring-brand-500 rounded appearance-none p-2 w-8 mr-1 text-center bg-transparent focus:outline-none focus:shadow-none font-sans border-none text-gray-700 placeholder-gray-400"
        :value="tmp[index - 1] || ''"
