...
- The following file branches on `DesktopNotificationsFeature::active()` — keep the active branch and delete the inactive branch:
...
`app/Filament/Plugins/HeadOnlyBrowserNotificationsPlugin.php` is unrelated to this flag — it permanently suppresses the vendor's floating prompt banner in favor of the Notifications page card, and stays regardless of this cleanup.
