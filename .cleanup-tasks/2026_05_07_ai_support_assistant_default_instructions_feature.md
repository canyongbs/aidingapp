...
- app-modules/ai/database/migrations/2026_05_13_120000_tmp_backfill_ai_support_assistant_default_instructions.php
...
- In `app-modules/ai/database/migrations/2026_05_07_094741_add_instructions_to_ai_support_assistant_settings.php`, remove the `AiSupportAssistantDefaultInstructionsFeature::activate()` / `deactivate()` calls and the `App\Features\AiSupportAssistantDefaultInstructionsFeature` import. Do **not** delete the migration file — it registers the `ai-support-assistant.instructions` setting property for fresh installs.
