...
- `database/landlord/2026_07_08_195324_data_activate_subscription_expiration_feature.php`
...
- In `app/Http/Controllers/Tenants/SyncTenantController.php`:
    ...
    2. Remove only the `use App\Features\SubscriptionExpirationFeature;` import. Leave the try/catch, the landlord connection transaction, and the `DB` / `Throwable` imports in place — they are permanent, not part of the feature flag.
