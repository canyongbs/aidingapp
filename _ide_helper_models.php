...
namespace AidingApp\Contact\Models{
     ...
     * @property-read Subscription|EngagementFileEntities|null $pivot
...
namespace AidingApp\InventoryManagement\Models{
     ...
     * @property-read Model|\Eloquent $checkedInFrom
     * @property-read Timeline|null $timelineRecord
     *
...
namespace AidingApp\InventoryManagement\Models{
     ...
     * @property-read Model|\Eloquent $checkedOutTo
     * @property-read mixed $status
     * @property-read Timeline|null $timelineRecord
     *
...
namespace AidingApp\Portal\Models{
     ...
     * @property-read Model|\Eloquent $voter
     *
