...
namespace App\Models{
     ...
     * @property-read NotificationSettingPivot|null $pivot
...
namespace App\Models{
     ...
     * @property Carbon|null $out_of_office_starts_at
     * @property Carbon|null $out_of_office_ends_at
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, ChangeRequestResponse> $changeRequestResponses
     * @property-read int|null $change_request_responses_count
     * @property-read Collection<int, ChangeRequestType> $changeRequestTypes
     ...
     * @property-read TwilioConversationUser|null $participant
     ...
     * @property-read Collection<int, Role> $roles
     * @property-read int|null $roles_count
     * @property-read ServiceMonitoringTargetUser|null $pivot
     * @property-read Collection<int, ServiceMonitoringTarget> $serviceMonitoringTargets
     * @property-read int|null $service_monitoring_targets_count
     * @property-read Collection<int, ServiceRequestAssignment> $serviceRequestAssignments
     * @property-read int|null $service_request_assignments_count
     * @property-read Collection<int, ServiceRequestType> $serviceRequestTypeIndividualAssignment
     * @property-read int|null $service_request_type_individual_assignment_count
     * @property-read Team|null $team
     * @property-read Collection|Permission[] $permissionsFromRoles
...
namespace AidingApp\Authorization\Models{
     ...
     * @property-read Collection<int, Role> $roles
     * @property-read int|null $roles_count
     * @property-read Collection<int, SystemUser> $systemUsers
...
namespace AidingApp\Contact\Models{
     ...
     * @property-read Collection<int, AssetCheckIn> $assetCheckIns
     * @property-read int|null $asset_check_ins_count
     * @property-read Collection<int, AssetCheckOut> $assetCheckOuts
     * @property-read int|null $asset_check_outs_count
     * @property-read User|null $assignedTo
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read User|null $createdBy
     * @property-read EngagementFileEntities|null $pivot
     ...
     * @property-read Collection<int, Engagement> $engagements
     * @property-read int|null $engagements_count
     * @property-read Collection<int, KnowledgeBaseArticleVote> $knowledgeBaseArticleVotes
     ...
     * @property-read Collection<int, Permission> $permissions
     * @property-read int|null $permissions_count
     * @property-read Collection<int, ProductLicense> $productLicenses
     * @property-read int|null $product_licenses_count
     * @property-read Collection<int, Role> $roles
     * @property-read int|null $roles_count
     * @property-read Collection<int, ServiceRequest> $serviceRequests
     * @property-read int|null $service_requests_count
     * @property-read ContactSource $source
     * @property-read ContactStatus $status
     * @property-read Collection<int, Task> $tasks
     * @property-read int|null $tasks_count
     * @property-read Timeline|null $timeline
     * @property-read Collection<int, PersonalAccessToken> $tokens
     * @property-read int|null $tokens_count
     *
...
namespace AidingApp\Contact\Models{
     ...
     *
     * @property string $id
     * @property SystemContactClassification $classification
     * @property string $name
     * @property ContactStatusColorOptions $color
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read Collection<int, Audit> $audits
...
namespace AidingApp\Contact\Models{
     ...
     * @property-read Collection<int, Contact> $contacts
     * @property-read int|null $contacts_count
     * @property-read OrganizationIndustry|null $industry
     * @property-read MediaCollection<int, Media> $media
     * @property-read int|null $media_count
     * @property-read OrganizationType|null $type
     *
...
namespace AidingApp\Engagement\Models{
     ...
     * @property-read EmailMessage|null $latestEmailMessage
     * @property-read MediaCollection<int, Media> $media
     * @property-read int|null $media_count
...
namespace AidingApp\Engagement\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property NotificationChannel|null $channel
     * @property string|null $subject
     * @property array<array-key, mixed>|null $body
     * @property Carbon|null $scheduled_at
...
namespace AidingApp\Engagement\Models{
     ...
     * @property Carbon|null $deleted_at
     * @property string|null $subject
     * @property EngagementResponseType $type
...
namespace AidingApp\Engagement\Models{
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<static>|UnmatchedInboundCommunication whereBody($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|UnmatchedInboundCommunication whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|UnmatchedInboundCommunication whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|UnmatchedInboundCommunication whereOccurredAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|UnmatchedInboundCommunication whereSender($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|UnmatchedInboundCommunication whereSubject($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|UnmatchedInboundCommunication whereType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|UnmatchedInboundCommunication whereUpdatedAt($value)
     *
     * @mixin \Eloquent
     */
    #[\AllowDynamicProperties]
...
namespace AidingApp\InAppCommunication\Models{
     ...
     * @property ConversationNotificationPreference $notification_preference
     * @property string|null $first_unread_message_sid
     * @property CarbonImmutable|null $first_unread_message_at
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read TwilioConversation $conversation
     * @property-read User|null $user
     *
...
namespace AidingApp\InventoryManagement\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, AssetCheckIn> $checkIns
     * @property-read int|null $check_ins_count
     * @property-read Collection<int, AssetCheckOut> $checkOuts
     * @property-read int|null $check_outs_count
     * @property-read AssetCheckIn|null $latestCheckIn
     * @property-read AssetCheckOut|null $latestCheckOut
     * @property-read AssetLocation $location
     * @property-read Collection<int, MaintenanceActivity> $maintenanceActivities
     * @property-read int|null $maintenance_activities_count
     * @property-read AssetStatus $status
     * @property-read AssetType $type
     *
...
namespace AidingApp\InventoryManagement\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read AssetCheckOut|null $checkOut
     * @property-read Model|\Eloquent|null $checkedInBy
     * @property-read Contact $checkedInFrom
...
namespace AidingApp\InventoryManagement\Models{
     ...
     * @property Carbon|null $expected_check_in_at
     * @property string|null $notes
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read AssetCheckIn|null $checkIn
     * @property-read Model|\Eloquent|null $checkedOutBy
     * @property-read Contact $checkedOutTo
...
namespace AidingApp\InventoryManagement\Models{
     ...
     *
     * @property string $id
     * @property SystemAssetStatusClassification $classification
     * @property string $name
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
...
namespace AidingApp\InventoryManagement\Models{
     ...
     * @property MaintenanceActivityStatus $status
     * @property string|null $notes
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read MaintenanceProvider|null $maintenanceProvider
     * @property-read Timeline|null $timelineRecord
     *
...
namespace AidingApp\KnowledgeBase\Models{
     ...
     * @property-read Collection<int, KnowledgeBaseCategory> $subCategories
...
namespace AidingApp\KnowledgeBase\Models{
     ...
     * @property-read Collection<int, KnowledgeBaseArticleVote> $votes
...
namespace AidingApp\LicenseManagement\Models{
     ...
     * @property-read ProductLicenseStatus $status
     *
...
namespace AidingApp\Notification\Models{
     ...
     * @property-read Model|\Eloquent|null $related
     *
...
namespace AidingApp\Notification\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read Collection<int, EmailMessageEvent> $events
...
namespace AidingApp\Notification\Models{
     ...
     * @property EmailMessageEventType $type
...
namespace AidingApp\Portal\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read KnowledgeBaseItem $knowledgeBaseArticle
     * @property-read Model $voter
     *
...
namespace AidingApp\Portal\Models{
     ...
     * @property PortalType|null $portal_type
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property-read Model|\Eloquent|null $educatable
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property-read Collection<int, ChangeRequestResponse> $approvals
     * @property-read int|null $approvals_count
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, ChangeRequestResponse> $responses
     * @property-read int|null $responses_count
     * @property-read ChangeRequestStatus $status
     * @property-read ChangeRequestType $type
     * @property-read User|null $user
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property string $id
     * @property string $name
     * @property SystemChangeRequestClassification $classification
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read Collection<int, Audit> $audits
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property-read Collection<int, ChangeRequest> $changeRequests
     * @property-read int|null $change_requests_count
     * @property-read Collection<int, User> $userApprovers
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read ServiceMonitoringTarget $serviceMonitoringTarget
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property-read IncidentSeverity $severity
     * @property-read IncidentStatus $status
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property string $id
     * @property string $name
     * @property SystemIncidentStatusClassification $classification
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read Collection<int, Audit> $audits
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property string|null $description
     * @property string $domain
     * @property ServiceMonitoringFrequency $frequency
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, HistoricalServiceMonitoring> $histories
     * @property-read int|null $histories_count
     * @property-read HistoricalServiceMonitoring|null $latestHistory
     * @property-read ServiceMonitoringTargetUser|ServiceMonitoringTargetTeam|null $pivot
     * @property-read Collection<int, Team> $teams
     * @property-read int|null $teams_count
     * @property-read Collection<int, User> $users
     * @property-read int|null $users_count
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property-read ServiceRequestAssignment|null $assignedTo
     * @property-read Collection<int, ServiceRequestAssignment> $assignments
     * @property-read int|null $assignments_count
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read User|null $createdBy
     * @property-read Division|null $division
     * @property-read ServiceRequestFeedback|null $feedback
     * @property-read Collection<int, ServiceRequestHistory> $histories
     * @property-read int|null $histories_count
     * @property-read ServiceRequestAssignment|null $initialAssignment
     * @property-read ServiceRequestUpdate|null $latestInboundServiceRequestUpdate
     * @property-read ServiceRequestUpdate|null $latestOutboundServiceRequestUpdate
     * @property-read MediaCollection<int, Media> $media
     * @property-read int|null $media_count
     * @property-read ServiceRequestPriority|null $priority
     * @property-read ServiceRequestFormSubmission|null $serviceRequestFormSubmission
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property ServiceRequestAssignmentStatus $status
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property string|null $deleted_at
     * @property-read Collection<int, ServiceRequestFormField> $fields
     * @property-read int|null $fields_count
     * @property-read Collection<int, ServiceRequestFormStep> $steps
     * @property-read int|null $steps_count
     * @property-read Collection<int, ServiceRequestFormSubmission> $submissions
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property-read ServiceRequestForm $submissible
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read ServiceRequestFormStep|null $step
     * @property-read ServiceRequestForm $submissible
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property FormSubmissionRequestDeliveryMethod|null $request_method
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property-read ServiceRequestType $type
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property ServiceRequestTypeAssignmentTypes $assignment_type
     ...
     * @property-read User|null $assignmentTypeIndividual
     * @property-read ServiceRequestTypeManager|ServiceRequestTypeAuditor|null $pivot
     * @property-read Collection<int, Team> $auditors
     * @property-read int|null $auditors_count
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read TenantServiceRequestTypeDomain|null $domain
     * @property-read ServiceRequestPriority|null $emailAutomaticCreationPriority
     * @property-read ServiceRequestForm|null $form
     * @property-read User|null $lastAssignedUser
     * @property-read Collection<int, Team> $managers
     * @property-read int|null $managers_count
     * @property-read Collection<int, ServiceRequestPriority> $priorities
     * @property-read int|null $priorities_count
     * @property-read Collection<int, ServiceRequest> $serviceRequests
     * @property-read int|null $service_requests_count
     * @property-read Collection<int, ServiceRequestTypeEmailTemplate> $templates
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read ServiceRequestType $serviceRequestType
     * @property-read Team $team
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property ServiceRequestTypeEmailTemplateRole|null $role
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read ServiceRequestType $serviceRequestType
     *
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, ServiceRequestPriority> $serviceRequestPriorities
...
namespace AidingApp\ServiceManagement\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read ServiceRequestType|null $serviceRequestType
...
namespace AidingApp\Task\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read ConfidentialTaskUser|ConfidentialTaskTeam|null $pivot
     * @property-read Collection<int, Team> $confidentialAccessTeams
     * @property-read int|null $confidential_access_teams_count
     * @property-read Collection<int, User> $confidentialAccessUsers
...
namespace AidingApp\Team\Models{
     ...
     * @property Carbon|null $updated_at
     * @property string|null $deleted_at
     * @property-read ServiceMonitoringTargetTeam|ServiceRequestTypeManager|ServiceRequestTypeAuditor|null $pivot
     * @property-read Collection<int, ServiceRequestType> $auditableServiceRequestTypes
     * @property-read int|null $auditable_service_request_types_count
     * @property-read Division|null $division
     * @property-read Collection<int, ServiceRequestType> $manageableServiceRequestTypes
