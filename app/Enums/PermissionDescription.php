...
enum PermissionDescription: string
{
    ...
    case Subscription = 'This permission group enables the display of the Subscription feature in the tertiary navigation group View Contact. Permission options include create and delete subscriptions. Note: This feature is currently gated by User permissions.';
