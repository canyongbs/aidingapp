...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format transforms grids', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
                'article_details' => [
                    'type' => 'doc',
                    'content' => [
                        [
            ...
            $migrate = Artisan::call('migrate', ['--path' => 'app-modules/knowledge-base/database/migrations/2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format.php']);

            expect($migrate)->toBe(Command::SUCCESS);

            $content = json_decode((string) DB::table('knowledge_base_articles')->where('id', $item->id)->value('article_details'), associative: true); /** @phpstan-ignore-line */
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format transforms youtube', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format transforms vimeo', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format removes hurdles and preserves children', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format transforms oversized images', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format transforms gridBuilder', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format transforms asymmetric grid', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format transforms checkedList', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format does not modify unchanged content', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $originalContent = [
...
test('2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format transforms textStyle marks to textColor', function () {
    isolatedMigration(
        '2026_04_08_114059_tmp_data_migrate_knowledge_base_articles_to_rich_editor_format',
        function () {
            $item = KnowledgeBaseItem::factory()->createQuietly([
