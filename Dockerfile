FROM ghcr.io/roadrunner-server/roadrunner:2024.3.2 AS roadrunner
...
RUN apt-get update \
    && apt-get install -y --no-install-recommends git gnupg zip unzip php8.2-apcu php8.2-pgsql php8.2-imagick php8.2-redis php8.2-pcov php8.2-xdebug \
